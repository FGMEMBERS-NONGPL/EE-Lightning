...
# Maintenance.nas
	...
	var airframe_load_speed = 100; # Speed in Kt at which airframe is under load, i.e. rotate speed
    ...
    var engine_hours = func {
         foreach ( var e ; props.globals.getNode(rm_room).getChildren("engine") ) {
		     var i = e.getIndex();
		    }	 
	    }	
