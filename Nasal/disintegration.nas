...
initPart("fuselage-forward", -3.7, 0, 0.154, 0.2, 0.25, 0.3);
initPart("fuselage-aft", 3.256, 0.02, -0.005, -0.3, -0.15, 0.4);
initPart("fin", 6.355, 0, 2.08, 0.4, -0.05, -0.15);
initPart("elevatorL", 7.235, -1.475, -0.478, 0.05, -0.46, -0.14);
initPart("elevatorR", 7.235, 1.475, -0.478, 0.05, 0.39, 0.14);
